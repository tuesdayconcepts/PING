...
// NOTE: In Next.js, client components must use NEXT_PUBLIC_* env vars.
// We also default API calls to same-origin so Vercel deployment “just works”.
const API_URL = '/api';
  ...
  useEffect(() => {
    const fetchWalletBalances = async () => {
      try {
        ...
        const settingsRes = await fetch(`${API_URL}/hints/settings`);
