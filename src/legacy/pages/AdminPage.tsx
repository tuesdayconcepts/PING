...
function AdminPage() {
  ...
  const { isLoaded } = useJsApiLoader({
    ...
    // Next.js exposes public env vars via NEXT_PUBLIC_* only.
    // Fallback to empty string to satisfy loader types; UI will still render but map won't load without a key.
